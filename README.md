...
- **Applicable to Both Classification and Regression:** <p align="justify">The RL algorithm implemented in coloured Petri nets (RLHCPN) is suitable for addressing both binary classification problems.</p>
...
- **`STEP 2:`**<p align="justify"> On the main page of the model, choose which activity will be performed by the algorithm (classification or regression). To do this, simply fire the transition (Choice Classification).</p>
